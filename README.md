...
- Disable mode
- no ps1 antimod support use ppfs for those games found https://consolecopyworld.com/  (infinity clones/modbo same as this though claim support it really don't, dms4lite clones unsure)
